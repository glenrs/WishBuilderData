...
dataOutFilegz=data2.tsv.gz
metadataOutFilegz=metadata2.tsv.gz
...
python parse2.py $cellLine $doseResponse $screenedComponents $RACS $variants $expression $metadataOutFilegz $dataOutFilegz 
