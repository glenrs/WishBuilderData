...
clinical=$inFiles/"GSE62944_06_01_15_TCGA_24_548_Clinical_Variables_9264_Samples.txt.gz"
...
#python parse3.py $clinical $patientCancerType $expression $transposedTumorTPM $dataOutFile $metadataOutFile
